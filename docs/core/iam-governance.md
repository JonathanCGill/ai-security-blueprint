...
| **Multi-agent IAM** | [MASO (Multi-Agent Security Operations) - Identity & Access](../maso/controls/identity-and-access.md) | Tiered controls for multi-agent systems: NHI lifecycle, mutual authentication, behavioral binding, delegation mandates |
