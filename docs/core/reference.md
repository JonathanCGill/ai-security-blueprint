...
*The full core implementation reference: reading order, the pattern, risk tiers, the document index, and key principles. New here? Start with the [Core overview](README.md).*
