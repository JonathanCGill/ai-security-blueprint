---
description: "The three-layer control model for AI runtime security: guardrails for known-bad patterns, a reviewing layer (semantic firewall for known-bad intent, Model-as-Judge for unknown-bad behaviour) at increasing depth, and human oversight for high-consequence decisions."
---
...
| Controls for multi-agent systems | [MASO Framework](../maso/README.md) - controls across 11 domains for agent orchestration |
