...
<!-- golden-thread-nav -->
!!! tip "Part of the Golden Thread (6 of 15)"
    Previous: [Why Your Guardrails Aren't Enough](why-guardrails-arent-enough.md) · Next: [The Semantic Firewall](../core/controls/semantic-firewall.md) · [See the full sequence](../reading-paths.md#the-golden-thread-guardrails-judges-and-why-they-work-together)
<!-- golden-thread-nav -->
