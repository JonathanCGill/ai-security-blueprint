...
**Where you begin depends on what you are doing now.** Three entry points, one triage.
...
-   **I am shipping an LLM feature in days, not weeks**
    ...
    Seven controls, one checklist, one decision tree. Deliberately short, deliberately opinionated. Once these are in place, you have an AIRSLite deployment: enough runtime safety to go live, enough observability to learn, enough structure to decide where to invest next.
...
- **[Fast Lane](fast-lane.md)** if your system qualifies as low-risk (internal, read-only, no regulated data, human in the loop) and you want to deploy without a formal security assessment.
- **[FAQ](faq.md)** for specific questions about scope, cost, vendor AI, team size, and how AIRS maps to ISO 42001 and other standards.
...
2. **[Quick Start](quick-start.md)** turns the short list into working code.
