...
- **Any multi-agent system** (multiple agents communicating, delegating, or acting autonomously - see [MASO (Multi-Agent Security Operations) Framework](maso/README.md))
