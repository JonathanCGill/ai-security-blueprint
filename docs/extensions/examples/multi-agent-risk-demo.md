...
!!! tip "Interactive demo"
    [Launch the interactive pipeline demo](../../maso/demo.md) to watch pre-recorded scenarios play through the full evaluation pipeline with animated step-by-step playback.
